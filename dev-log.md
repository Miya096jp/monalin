...
[メインUIの各メニュー表示/非表示をStimulusで制御する #95](https://github.com/Miya096jp/monalin/issues/95)
## Commits
Feature: Stimulusでハンバーガーメニューの開閉を実装(03954f)
Feature: サブメニューの開閉を実装(af046b)
Feature: セッションリストの編集・削除メニュー開閉を実装(47a1db)
## 補足
- 未ログインユーザーのリダイレクトをApplicationコントローラーに実装後、system specを追加する
...
## Issue
[UIの構造的デザイン（モバイルファースト） #44](https://github.com/Miya096jp/monalin/issues/44)
## Commits
Config: tailwindCSSのインストール(b1f6a6)
Bugfix: action_text-trixをupdate(930e40)
Chore: README更新(a2f0e1)
Chore: 既存のSessionsControllerをAuthSessionsに名称変更(5f2c1d)
